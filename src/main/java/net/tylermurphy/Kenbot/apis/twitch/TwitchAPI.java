package net.tylermurphy.Kenbot.apis.twitch;
...
import net.tylermurphy.Kenbot.apis.API;
...
public class TwitchAPI extends API {
	...
	private static boolean invalidResponse(JSONObject json) throws DuplicateWebhookException, Exception {
		String status = null;
		try {
