...
import net.tylermurphy.commands.fun.TrumpQuote;
...
import net.tylermurphy.commands.nsfw.Blowjob;
import net.tylermurphy.commands.nsfw.Boobs;
import net.tylermurphy.commands.nsfw.Cum;
import net.tylermurphy.commands.nsfw.E621;
import net.tylermurphy.commands.nsfw.Hentai;
import net.tylermurphy.commands.nsfw.HentaiGIF;
...
import net.tylermurphy.commands.nsfw.Spank;
import net.tylermurphy.commands.nsfw.Tits;
...
public class CommandRegister {
	...
	public static void registerCommands() {
		...
		register(new Blowjob());
		register(new Boobs());
		register(new Cum());
		register(new Hentai());
		register(new HentaiGIF());
		register(new Kuni());
		register(new Lewd());
		register(new LewdKemo());
		register(new Pussy());
		register(new SmallBoobs());
		register(new Spank());
		register(new Tits());
		register(new LoopQueue());
		register(new Remove());
		register(new EightBall());
		register(new TrumpQuote());
		register(new Warn());
		register(new Warns());
